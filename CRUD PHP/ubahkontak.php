...
$query = "SELECT * FROM kontak WHERE id=$selected_id";

$r = mysqli_fetch_assoc(mysqli_query($koneksi, $query));

?>

<div class="container mt-5">
                <h2>Form Kontak</h2>
                <form action="tampilkanKontak.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="5" id="pertanyaan" name="pertanyaan" value="<?php echo $r['pertanyaan']; ?>" required></textarea>
                    </div>
